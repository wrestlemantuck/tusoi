// credits to https://blooketbot.me/https://blooketbot.glitch.me/https://blooketbot.vercel.app/
var blooks = [
  "Chick",
  "Chicken",
  "Cow",
...
<div class="mainbodychat" id="mainbodychat">
    ...
    <div class="headerdraggable" id="draggable">
        <button class="action_button" onclick="openExternalLink('blooket.com')">📃</button>
    ...
    <div class="channelinfo" id="draggable">
        ...
        <h3 class="channeltitle">#blooket-cheat-chat-link</h3>
    </div>
